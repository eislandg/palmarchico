        ...
        <div className="max-w-4xl mx-auto bg-charcoal rounded-3xl overflow-hidden shadow-2xl border border-white/5 flex flex-col md:flex-row">
          ...
          <div className="md:w-5/12 bg-gradient-to-br from-accent-green/20 to-black p-10 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 w-full h-full text-center flex flex-col items-center justify-center">
                <h3 className="text-3xl font-bold uppercase tracking-tight mb-4">Join The <span className="text-white">Guestlist</span></h3>
                <p className="text-zinc-300 font-light mb-8">Sign up for early access to tickets, exclusive event announcements, and VIP perks.</p>
          ...
          <div className="md:w-7/12 p-10 md:p-12">
            <form className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-zinc-400 mb-2 uppercase tracking-wide">Full Name</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <User className="h-5 w-5 text-zinc-500" />
                  </div>
                  <input type="text" className="w-full bg-black/50 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-white placeholder-zinc-600 focus:outline-none focus:border-accent-green focus:ring-1 focus:ring-accent-green transition-all" placeholder="John Doe" />
                </div>
              </div>

              <div>
                <label className="block text-sm font-medium text-zinc-400 mb-2 uppercase tracking-wide">Email Address</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Mail className="h-5 w-5 text-zinc-500" />
                  </div>
                  <input type="email" className="w-full bg-black/50 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-white placeholder-zinc-600 focus:outline-none focus:border-accent-green focus:ring-1 focus:ring-accent-green transition-all" placeholder="john@example.com" />
                </div>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-zinc-400 mb-2 uppercase tracking-wide">Phone Number</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
